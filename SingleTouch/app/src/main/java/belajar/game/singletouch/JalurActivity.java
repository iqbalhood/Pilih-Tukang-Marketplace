...
public class JalurActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switch(grade) {
            case 1 :
                ...
                gambarview.setBackgroundResource(R.drawable.jalur1);
                break;
            case 2 :
                System.out.println("Case 2 ");
                gambarview.setBackgroundResource(R.drawable.jalur2);
                break;
            case 3 :
                System.out.println("Case 3 ");
                gambarview.setBackgroundResource(R.drawable.jalur3);
            case 4 :
                System.out.println("Case 4 ");
                gambarview.setBackgroundResource(R.drawable.jalur4);
                break;
            default :
